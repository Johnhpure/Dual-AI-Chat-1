...
export const generateResponse = async (
  ...
  try {
    ...
    // 简化错误消息，不再区分环境变量和自定义配置
    specificMissingKeyMsg = "API密钥未提供。";
    specificInvalidKeyMsg = customApiKey?.trim() ? "提供的API密钥无效或权限不足。" : specificMissingKeyMsg;
